...
<template>
    <RpgkCard id="fate-consequences" :class="{ readonly: readonly }" fill no-body>
        <template #header>
            <div class="d-flex">
                <h5 class="align-items-center d-flex text-nowrap m-0 me-2 flex-grow-0 flex-shrink-0 w-auto">
                    <Fa class="me-1" icon="skull-crossbones" />
        ...
        <!-- Modals -->
        <EditConsequencesModal ref="editModal" :skills="props.skills" @save="onEditSave" />
    </RpgkCard>
</template>
...
<script lang="ts" setup>
    ...
    // Interfaces
    import type { FateAspect, FateSkill } from '@rpgk/core/models/systems';
